...
cl = LINETCR.LINE() 
#cl.login(qr=True)
cl.login(token="Eo7MCifNvGLxKXdJ46Re.OXL+t22+aitfnDddi909FG.OfCLezD6DrB8i9WViqHB2gcYcrOhz4F2rSbgbMP54bk=")
cl.loginResult()

ki = LINETCR.LINE() 
ki.login(token="EoLLMFhBmrYJdJjaxeYd.yumS/kIsb04Z5tElt/pWNq.xkFvZnjui0QPZXnErK/oGAzWXBsO+n1/n7jhc6yiZuM=")
ki.loginResult()

ki2 = LINETCR.LINE() 
ki2.login(token="EoerrjK01AIT6rlAXUG6.nfd1Z9h1Kk4+jnD//49C5G.eDd6cHFOAu/lfcibOEnsud04DRIBUy6fZiM78gKBtMY=")
ki2.loginResult()

ki3 = LINETCR.LINE() 
ki3.login(token="EoVA4XO2CdIGr0MqECy7.mYGtGX0KahmF9JtIf29HfW.y6YabGbp9Y2sdTtmR62NnI5pBwOmRD68VRdYl1huA7s=")
ki3.loginResult()

ki4 = LINETCR.LINE() 
ki4.login(token="EoGRVP0Q1GenOvy608Qe./DyP6ZuJJ+1NYNQsLN3+pG.UJguMKQ3SiobxxsEH/RvIvKOLX0xCl7eaVIAaWtSVkU=")
ki4.loginResult()

ki5 = LINETCR.LINE() 
ki5.login(token="Eo4yJcy3NMsIukQnPTJ6.nXSuvJexWi7rQU01Xl0aPG.cy5xGnX/JimevGPs89dxPEtHMdzEi1+nED68RIuRJRI=")
ki5.loginResult()

ki6 = LINETCR.LINE() 
ki6.login(token="EoUBcgKZdxLImCaLpwzd.P2h6MrI/27zcPlfera0E7q.kxtiEJltWshrFL9ab/SOOuX68j78Cu+4nvJfJhVD2nM=")
ki6.loginResult()
...
Gn เปลี่ยนชื่อกลุ่ม
Gn: เปลี่ยนชื่อกลุ่ม
jointicket on เปิดการเชิญตั๋ว
jointicket off ปิดการเชิญตั๋ว
Album เข้าห้องที่เชิญทั้งหมด
cancel ยกเลิกห้องเชิญทั้งหมด
Tagall สั่งแทร็ก
@@ สั่งแทร็ก
Copy @ ขโมย
Already Liked เปิดออโต้ไลค์
Nuke ทำลายกลุ่ม
respon เช็คบอท
Spam on สแปมเปิด
Spam off สแปมปิด
#leave อออกแชทรวม
Spam @ สแปม
เช็ค รับตรวจจับรายชื่อ
อ่าน สั่งดูรายชื่อคนออ่าน
Unban: บชขาว
Unban @ บชขาว
Ban: บชดำ
Comban ทำดำ
Comban del ทำดำ
Comban cek เช็ครายการบชดำ
Mygroups เช็ครายชื่อกลุ่ม
Ban แบนกลุ่ม
Bye ออกกลุ่ม
Fuck @ เตะ
update ล็อคชื่ตามโค้ด
Clockname ชื่อเวลา
Clock:off ปิดเวลาในชื่อ
Clock:on เปิดเวลาในชื่อ
Gurl เปิดลิ้งค์
gurl เปิดลิ้งค์
gurl+ เปิดลิ้งค์
Curl ปิดลิ้งค์กลุ่ม
Com เช็คคอมเม้น
Comment:on คอมเม้นเปิด
Com:off คอมเม้นปิด
Com set: ตั้งค่าคอมเม้น
Message set ตั้งค่าข้อความ
Change เช็คข้อความ
Pesan add cek เช็คข้อความ
Msg add- เช็คข้อความแอด
Help set: ตั้งค่าคำสั่ง
Message set: ตั้งค่าข้อความ
Add:off แอดออโต้เปิด
Add:on แอดออโต้ปิด
Album deleted: ลบอัลบั้ม
Gcancelall ยกเลิกรัน
group id เช็คไอดีกลุ่ม
Gowner เช็ครายละเอียดกลุ่ม
Add ผู้ดูแลระบบ
set เช็คตั้งค่า
Share:on แชร์เปิด
Share:off แชร์ปิด
Leave:on ป้องกันการรันแชทเปิด
Leave:off ป้องกันการรันแชทปิด
Gcancel:on ป้องกันการรันเปิด
Gcancel:off ป้องกันการรันปิด
Procancel:on ป้องกันยกเลิกเปิด
Procancel:off ป้องกันยกเลิกปิด
Proinvite:on ป้องกันเชิญเปิด
Proinvite:off ป้องกันเชิญปิด
Prolink:on ป้องกันลิ้งค์เปิด
Prolink:off ป้องกันลิ้งค์ปิด
Pro:off ป้องกันปิด
Pro:on ป้องกันเปิด
join:off เข้าออโต้ปิด
join:on เข้าออโต้เปิด
contact:off เช็คคอนแทคเปิด
contact:on เช็คคอนแทเปิด
blocklist รายการบล็อก
TL: ลิ้งค์โพส
All mid midBotทุกตัว
Contact คออนแทค
Ginfo เช็ครายละเอียดกลุ่ม
Cancel ยกเลิกค้างเชิญทั้งหมด
B Cancel ยกเลิกค้างเชิญทั้งหมด
...
admsa = "ua3197f4f6dbf0084c535d0c323dd3d7e"
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "ua3197f4f6dbf0084c535d0c323dd3d7e":
                    if "join:" in msg.text:
